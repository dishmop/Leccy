...
public class CircuitElementExit : CircuitElement {
	public GameObject 	exitPrefab;
	public GameObject	displayMesh;
	public float		resistance = 1;
	public float 		thresholdCurrent = 2;
	public Color		offCol;
	public Color		halfOnCol;
	public Color		onCol;
	


	public void Start(){
		Debug.Log ("CircuitElementExit:Start()");
	}
	...
	void Awake () {
		displayMesh = Instantiate(exitPrefab, gameObject.transform.position, Quaternion.Euler(0, 0, orient * 90)) as GameObject;
